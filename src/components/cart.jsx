...
export default function CartBox() {
    ...
    return (
        <section className='absolute font-Manrope z-50 top-[115px] right-[24px] flex flex-col bg-[#FFF] rounded-[8px] w-[327px] h-[495px] py-[32px] px-[28px] gap-[30px] md:right-10 xl:w-[377px]'>
